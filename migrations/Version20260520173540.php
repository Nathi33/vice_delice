 ...
 */
final class Version20260520173540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04AD349173CD ON product (supplier_reference)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_D34A04AD349173CD ON product');
        $this->addSql('DROP INDEX IDX_D34A04AD44F5D008 ON product');
        $this->addSql('ALTER TABLE product ADD is_featured_home TINYINT NOT NULL, DROP supplier_reference, DROP is_active, DROP created_at, DROP updated_at, CHANGE price price NUMERIC(10, 2) NOT NULL, CHANGE stock stock INT NOT NULL, CHANGE seo_slug main_image VARCHAR(255) DEFAULT NULL, CHANGE brand_id home_position INT DEFAULT NULL');
